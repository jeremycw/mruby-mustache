...
typedef struct {
	int (*context_find)(crustache_var *, crustache_var_data context, const char *key, size_t key_size);
	int (*list_get)(crustache_var *, crustache_var_data list, size_t i);
	int (*lambda)(crustache_var *, crustache_var_data lambda, const char *raw_template, size_t raw_size);
	void (*var_free)(crustache_var_t type, crustache_var_data var);
